...
OPCODE_TO_TEXT: Dict[BinaryOpcode, str] = {
    ...
    BinaryOpcode.REF_NULL: 'ref.null',
    BinaryOpcode.REF_IS_NULL: 'ref.is_null',
    BinaryOpcode.REF_FUNC: 'ref.func',
    ...
    BinaryOpcode.TABLE_GET: "table.get",
    BinaryOpcode.TABLE_SET: "table.set",
    BinaryOpcode.TABLE_INIT: "table.init",
    BinaryOpcode.ELEM_DROP: "elem.drop",
    BinaryOpcode.TABLE_COPY: "table.copy",
    BinaryOpcode.TABLE_GROW: "table.grow",
    BinaryOpcode.TABLE_SIZE: "table.size",
    BinaryOpcode.TABLE_FILL: "table.fill",
